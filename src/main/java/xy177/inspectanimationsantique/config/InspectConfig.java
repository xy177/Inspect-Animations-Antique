...
public final class InspectConfig {
    ...
    @Config.LangKey("config.inspect_animations_antique.category.general")
    ...
    @Config.LangKey("config.inspect_animations_antique.category.animations")
    ...
    @Config.LangKey("config.inspect_animations_antique.category.custom")
    ...
    @Config.LangKey("config.inspect_animations_antique.category.performance")
    ...
    public static final class General {
        ...
        @Config.LangKey("config.inspect_animations_antique.default_animation")
        public InspectAnimation defaultAnimation = InspectAnimation.TURN;

        @Config.LangKey("config.inspect_animations_antique.enable_random")
        public boolean enableRandom = true;
        @Config.LangKey("config.inspect_animations_antique.enable_none")
        public boolean enableNone = false;
        @Config.LangKey("config.inspect_animations_antique.enable_turn")
        public boolean enableTurn = true;
        @Config.LangKey("config.inspect_animations_antique.enable_toss")
        public boolean enableToss = true;
        @Config.LangKey("config.inspect_animations_antique.enable_flip")
        public boolean enableFlip = true;
        @Config.LangKey("config.inspect_animations_antique.enable_flourish")
        public boolean enableFlourish = true;
    }

    public static final class Animations {
        @Config.RangeInt(min = 20, max = 1800)
        @Config.LangKey("config.inspect_animations_antique.turn_duration")
        public int turnDuration = 600;

        @Config.RangeInt(min = 20, max = 1800)
        @Config.LangKey("config.inspect_animations_antique.toss_duration")
        public int tossDuration = 600;

        @Config.RangeInt(min = 20, max = 1800)
        @Config.LangKey("config.inspect_animations_antique.flip_duration")
        public int flipDuration = 600;

        @Config.RangeInt(min = 20, max = 2400)
        @Config.LangKey("config.inspect_animations_antique.flourish_duration")
        public int flourishDuration = 800;

        @Config.RangeInt(min = 1, max = 20)
        @Config.LangKey("config.inspect_animations_antique.flip_loops")
        public int flipLoops = 2;

        @Config.RangeInt(min = 1, max = 20)
        @Config.LangKey("config.inspect_animations_antique.flourish_loops")
        public int flourishLoops = 5;
    }

    public static final class CustomAnimations {
        @Config.LangKey("config.inspect_animations_antique.enable_block_animation")
        public boolean enableBlockAnimation = false;
        @Config.LangKey("config.inspect_animations_antique.block_animation")
        ...
        @Config.LangKey("config.inspect_animations_antique.enable_item_animations")
        public boolean enableItemAnimations = false;

        @Config.LangKey("config.inspect_animations_antique.turn_items")
        public String[] turnItems = new String[0];
        @Config.LangKey("config.inspect_animations_antique.toss_items")
        public String[] tossItems = new String[0];
        @Config.LangKey("config.inspect_animations_antique.flip_items")
        public String[] flipItems = new String[0];
        @Config.LangKey("config.inspect_animations_antique.flourish_items")
        public String[] flourishItems = new String[0];
        @Config.LangKey("config.inspect_animations_antique.none_items")
    ...
    public static final class Performance {
        ...
        @Config.LangKey("config.inspect_animations_antique.max_delta")
