package xy177.inspectanimations.common;
...
import xy177.inspectanimations.network.AnimationSyncMessage;
import xy177.inspectanimations.network.HandshakeMessage;
...
public final class CommonEventHandler {
    ...
    private static boolean hasRemoteMod(EntityPlayerMP player) {
        ...
        return dispatcher != null && dispatcher.getModList() != null
                && dispatcher.getModList().containsKey(InspectAnimations.MOD_ID);
    }
}
