...
public final class InspectConfig {
    ...
    @Config.LangKey("config.inspectanimations.category.animations")
    ...
    @Config.LangKey("config.inspectanimations.category.custom")
    ...
    @Config.LangKey("config.inspectanimations.category.performance")
    ...
    public static final class General {
        ...
        @Config.LangKey("config.inspectanimations.default_animation")
        public InspectAnimation defaultAnimation = InspectAnimation.TURN;

        @Config.LangKey("config.inspectanimations.enable_random")
        public boolean enableRandom = true;
        @Config.LangKey("config.inspectanimations.enable_none")
        public boolean enableNone = false;
        @Config.LangKey("config.inspectanimations.enable_turn")
        public boolean enableTurn = true;
        @Config.LangKey("config.inspectanimations.enable_toss")
        public boolean enableToss = true;
        @Config.LangKey("config.inspectanimations.enable_flip")
        public boolean enableFlip = true;
        @Config.LangKey("config.inspectanimations.enable_flourish")
        public boolean enableFlourish = true;
    }

    public static final class Animations {
        @Config.RangeInt(min = 20, max = 1800)
        @Config.LangKey("config.inspectanimations.turn_duration")
        public int turnDuration = 600;

        @Config.RangeInt(min = 20, max = 1800)
        @Config.LangKey("config.inspectanimations.toss_duration")
        public int tossDuration = 600;

        @Config.RangeInt(min = 20, max = 1800)
        @Config.LangKey("config.inspectanimations.flip_duration")
        public int flipDuration = 600;

        @Config.RangeInt(min = 20, max = 2400)
        @Config.LangKey("config.inspectanimations.flourish_duration")
        public int flourishDuration = 800;

        @Config.RangeInt(min = 1, max = 20)
        @Config.LangKey("config.inspectanimations.flip_loops")
        public int flipLoops = 2;

        @Config.RangeInt(min = 1, max = 20)
        @Config.LangKey("config.inspectanimations.flourish_loops")
        public int flourishLoops = 5;
    }

    public static final class CustomAnimations {
        @Config.LangKey("config.inspectanimations.enable_block_animation")
        public boolean enableBlockAnimation = false;
        @Config.LangKey("config.inspectanimations.block_animation")
        ...
        @Config.LangKey("config.inspectanimations.enable_item_animations")
        public boolean enableItemAnimations = false;

        @Config.LangKey("config.inspectanimations.turn_items")
        public String[] turnItems = new String[0];
        @Config.LangKey("config.inspectanimations.toss_items")
        public String[] tossItems = new String[0];
        @Config.LangKey("config.inspectanimations.flip_items")
        public String[] flipItems = new String[0];
        @Config.LangKey("config.inspectanimations.flourish_items")
        public String[] flourishItems = new String[0];
        @Config.LangKey("config.inspectanimations.none_items")
    ...
    public static final class Performance {
        ...
        @Config.LangKey("config.inspectanimations.max_delta")
