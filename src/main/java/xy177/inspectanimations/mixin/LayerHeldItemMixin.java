...
public abstract class LayerHeldItemMixin {
    ...
    private void inspectAnimations$translateToHand(
            LayerHeldItem owner, EnumHandSide side, EntityLivingBase entity) {
        if (entity instanceof AbstractClientPlayer) {
            AnimationState state = ((IAnimationState) entity).inspectAnimations$getAnimationState();
    ...
    private void inspectAnimations$renderThirdPersonItem(
